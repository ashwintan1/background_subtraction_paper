...
% Load video
input_video = 'ShoppingMallShorter.m1v';
...
addpath('.\TFOCS-1.4');   % add TFOCS to your path, so change this to suit your computer
...
width = 160;
height = 128;
mat  = @(x) reshape(x, [height, width, 3]);
figure();
colormap('Gray');
